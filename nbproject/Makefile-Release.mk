...
${OBJECTDIR}/source/Log.o: source/Log.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Log.o source/Log.cpp

${OBJECTDIR}/source/MWindow.o: source/MWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/MWindow.o source/MWindow.cpp
